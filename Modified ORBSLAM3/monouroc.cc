...
*
* Copyright (C) 2017-2020 Carlos Campos, Richard Elvira, Juan J.  ,  M.M. Montiel and Juan D. , University of Zaragoza.
* Copyright (C) 2014-2016  Mur-Artal,  M.M. Montiel and Juan D. , University of Zaragoza.
*
...
int main(int argc, char **argv){  
    ...
    //***** COMMANDS CONNECTION *****//
     ...
     fprintf(stderr, "ConnectedÂ°commands\nPress 'q' to quit\n");
